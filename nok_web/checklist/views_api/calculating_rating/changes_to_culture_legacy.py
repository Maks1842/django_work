...
def culture_legacy_rating(ratings_json, count_person):
    ...
    ratings = {
        ...
        "rating_3_1_1": {"value": ratings_json["rating_3_1_1"],
                         "name": Coefficients.name["rating_3_1_1"]},
        "rating_3_1_2": {"value": ratings_json["rating_3_1_2"],
                         "name": Coefficients.name["rating_3_1_2"]},
        "rating_3_1_3": {"value": ratings_json["rating_3_1_3"],
                         "name": Coefficients.name["rating_3_1_3"]},
        "rating_3_1_chair": {"value": ratings_json["rating_3_1_chair"],
                             "name": Coefficients.name["rating_3_1_chair"]},
        "rating_3_1_toilet": {"value": ratings_json["rating_3_1_toilet"],
