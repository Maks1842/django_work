...
def culture_legacy_rating(quota, invalid_person, answers, form_json, grouping_json):
    ...
    ratings = {
        ...
        "rating_3_1_1": {"value": rating_3_1_1,
                         "name": Coefficients.name["rating_3_1_1"]},
        "rating_3_1_2": {"value": rating_3_1_2,
                         "name": Coefficients.name["rating_3_1_2"]},
        "rating_3_1_3": {"value": rating_3_1_3,
                         "name": Coefficients.name["rating_3_1_3"]},
        "rating_3_1_chair": {"value": rating_3_1_chair,
                             "name": Coefficients.name["rating_3_1_chair"]},
        "rating_3_1_toilet": {"value": rating_3_1_toilet,
                              "name": Coefficients.name["rating_3_1_toilet"]},
        ...
        "rating_5_2": {"value": rating_respondents['rating_5_2'],
                       "name": Coefficients.name["rating_5_2_education"]},
        "count_person_5_2": {"value": int(rating_respondents['count_person_5_2']),
                             "name": Coefficients.name["count_person_5_2_education"]},
