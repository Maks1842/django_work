...
def healthcare_rating(ratings_json, count_person):
    ...
    rating_2_2 = round((ratings_json["ratings"]["rating_2_2_1"] + rating_2_2_2)/2, 0)
    rating_2 = round(ratings_json["ratings"]["rating_2_1"]["rating"] * float(cfcnt_main["k_2_1"]) + rating_2_2 * float(cfcnt_main["k_2_2"]) + rating_2_3 * float(cfcnt_main["k_2_3"]), 1)
    ...
    ratings = {
        ...
        "rating_2_2_1": ratings_json["ratings"]["rating_2_2_1"],
