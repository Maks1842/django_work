...
def healthcare_rating(ratings_json, count_person):
    ...
    rating_2_2 = round((ratings_json["rating_2_2_1"] + rating_2_2_2)/2, 0)
    rating_2 = round(ratings_json["rating_2_1"]["rating"] * float(cfcnt_main["k_2_1"]) + rating_2_2 * float(cfcnt_main["k_2_2"]) + rating_2_3 * float(cfcnt_main["k_2_3"]), 1)
    ...
    ratings = {
        ...
        "rating_1_1": ratings_json["rating_1_1"],
        "rating_1_2": ratings_json["rating_1_2"],
        ...
        "rating_2_1": ratings_json["rating_2_1"],
        "rating_2_2": rating_2_2,
        "rating_2_2_1": ratings_json["rating_2_2_1"],
        "rating_2_2_2": rating_2_2_2,
        "count_person_2_2_2": int(count_person["count_person_2_2_2"]),
        "rating_2_3": rating_2_3,
        "count_person_2_3": int(count_person["count_person_2_3"]),

        "rating_3_1": ratings_json["rating_3_1"],
        "rating_3_2": ratings_json["rating_3_2"],
