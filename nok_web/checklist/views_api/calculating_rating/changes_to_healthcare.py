...
def healthcare_rating(ratings_json, count_person):
    ...
    # rating_2_2_2 = round(int(count_person["count_person_2_2_2"])/quota * 100, 0)
    ...
    # rating_2_2 = round((ratings_json["rating_2_2_1"]['value'] + rating_2_2_2)/2, 0)
    # rating_2 = round(ratings_json["rating_2_1"]['value'] * float(cfcnt_main["k_2_1"]) + rating_2_2 * float(cfcnt_main["k_2_2"]) + rating_2_3 * float(cfcnt_main["k_2_3"]), 1)
    ...
    #                    "parent": name["rating_2_2"]["parent"],
    #                    "order_num": name["rating_2_2"]["order_num"]},
    #     "rating_2_2_1": {"id": name["rating_2_2_1"]["id"],
    #                      "value": ratings_json["rating_2_2_1"]['value'],
    #                      "name": name["rating_2_2_1"]["text"],
    #                      "parent": name["rating_2_2_1"]["parent"],
    #                      "order_num": name["rating_2_2_1"]["order_num"]},
    #     "rating_2_2_2": {"id": name["rating_2_2_2"]["id"],
    #                      "value": rating_2_2_2,
    #                      "name": name["rating_2_2_2"]["text"],
    #                      "parent": name["rating_2_2_2"]["parent"],
    #                      "order_num": name["rating_2_2_2"]["order_num"]},
    #     "count_person_2_2_2": {"id": name["count_person_2_2_2"]["id"],
    #                            "value": int(count_person["count_person_2_2_2"]),
    #                            "name": name["count_person_2_2_2"]["text"],
    #                            "parent": name["count_person_2_2_2"]["parent"],
    #                            "order_num": name["count_person_2_2_2"]["order_num"]},
    ...
    #                    "parent": name["rating_5_2"]["parent"],
    #                    "order_num": name["rating_5_2"]["order_num"]},
    #     "count_person_5_2": {"id": name["count_person_5_2"]["id"],
    #                          "value": int(count_person["count_person_5_2"]),
    #                          "name": name["count_person_5_2"]["text"],
    #                          "parent": name["count_person_5_2"]["parent"],
    #                          "order_num": name["count_person_5_2"]["order_num"]},
